...
remaining_prs: oh-my-harness-release-followup,my-desk-setup-host-harness
...
- `src/environment/native-registration.ts`, `src/environment/orchestrator.ts`: snapshot과
  ...
  duplicate, foreign registration은 collision으로 보존한다. receipt에는 canonical resolution
