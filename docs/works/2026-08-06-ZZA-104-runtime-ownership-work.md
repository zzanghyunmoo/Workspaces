...
pr_url: https://github.com/zzanghyunmoo/my-desk-setup/pull/7
...
OMH PR #40 closeout은 완료했다. MDS PR #7의 merge와 OMH release-lock follow-up이 남아 Linear는 In Review를 유지한다.
