...
- 보강 head `d90d4c9b23978af652404710aeb94da1be37672d`에서 Editor는 base checkout만
...
- 최종 head `fb57c3d9cde044a7d345a9249b2337d848ea9228`에서 동일 revision의 base runtime
  repair가 exact IDE plugin spec을 보존하도록 공통 config와 plugin spec 게시 경계를 분리하고,
  base checkout drift 복구 전후 IDE spec bytes가 동일한 회귀 테스트를 추가했다.
